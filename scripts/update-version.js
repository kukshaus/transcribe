...
const newVersionContent = `// App version configuration
...
console.log(`✅ Version updated to ${currentVersion} (build: ${buildNumber})`)
console.log(`📝 Updated lib/version.ts`)

// Optional: Update package.json version to sync
